...
import { ContactModal } from "../features/ui/contactmodal/contactmodal";

const IssuesPage = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);

  useEffect(() => {
    console.log(isModalOpen); // This will log the updated state
  }, [isModalOpen]);
          ...
          <div className={styles.headingContainer}>
            ...
            <div className={styles.supportingTextWrap}>
              <p className={styles.supportingText}>
                Powerful error tracking and monitoring for software
                applications. Trusted by over 4,000 startups.
              </p>
            </div>
            <Image
